...
public class OpenApiDocumentationLanguage : Dictionary<string, string>
{
   ...
   public static OpenApiDocumentationLanguage Default
    ...
    public static OpenApiDocumentationLanguage Ko
      => new()
      {
         { OpenApiDocumentationLanguageConst.Info, "ǥ��" },
         { OpenApiDocumentationLanguageConst.Title, "����" },
         { OpenApiDocumentationLanguageConst.Version, "����" },
         { OpenApiDocumentationLanguageConst.Description, "����" },

         { OpenApiDocumentationLanguageConst.Path, "���" },
         { OpenApiDocumentationLanguageConst.PathSummary, "��� ���" },
         { OpenApiDocumentationLanguageConst.PathDescription, "��� ����" },
